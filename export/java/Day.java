...
public class Day {
  ...
  public static Day fromSolar(int _year, short _month, int _day) {
    long cPtr = sxtwlJNI.Day_fromSolar__SWIG_0(_year, _month, _day);
    return (cPtr == 0) ? null : new Day(cPtr, false);
  }

  public static Day fromSolar(int _year, short _month, int _day, int _hour, int _minute, int _second) {
    long cPtr = sxtwlJNI.Day_fromSolar__SWIG_1(_year, _month, _day, _hour, _minute, _second);
    return (cPtr == 0) ? null : new Day(cPtr, false);
  }
