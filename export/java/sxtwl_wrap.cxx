...
SWIGINTERN jint std_vector_Sl_sxtwl_JieQiInfo_Sg__doCapacity(std::vector< sxtwl::JieQiInfo > *self){
        return SWIG_VectorSize(self->capacity());
      }
SWIGINTERN void std_vector_Sl_sxtwl_JieQiInfo_Sg__doReserve(std::vector< sxtwl::JieQiInfo > *self,jint n){
        if (n < 0)
          throw std::out_of_range("vector reserve size must be positive");
        self->reserve(n);
      }
...
SWIGEXPORT jint JNICALL Java_com_seantone_sxtwl_sxtwlJNI_JDList_1doCapacity(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  std::vector< double > *arg1 = (std::vector< double > *) 0 ;
  jint result;
...
SWIGEXPORT void JNICALL Java_com_seantone_sxtwl_sxtwlJNI_JDList_1doReserve(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  std::vector< double > *arg1 = (std::vector< double > *) 0 ;
  jint arg2 ;
...
SWIGEXPORT jint JNICALL Java_com_seantone_sxtwl_sxtwlJNI_JQList_1doCapacity(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  std::vector< sxtwl::JieQiInfo > *arg1 = (std::vector< sxtwl::JieQiInfo > *) 0 ;
  jint result;
  ...
  arg1 = *(std::vector< sxtwl::JieQiInfo > **)&jarg1; 
  try {
    result = std_vector_Sl_sxtwl_JieQiInfo_Sg__doCapacity(arg1);
  } catch(std::out_of_range &_e) {
    SWIG_JavaThrowException(jenv, SWIG_JavaIndexOutOfBoundsException, (&_e)->what());
    return 0;
  }
...
SWIGEXPORT void JNICALL Java_com_seantone_sxtwl_sxtwlJNI_JQList_1doReserve(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  std::vector< sxtwl::JieQiInfo > *arg1 = (std::vector< sxtwl::JieQiInfo > *) 0 ;
  jint arg2 ;
  ...
  arg2 = jarg2; 
  try {
    std_vector_Sl_sxtwl_JieQiInfo_Sg__doReserve(arg1,SWIG_STD_MOVE(arg2));
  } catch(std::length_error &_e) {
    SWIG_JavaThrowException(jenv, SWIG_JavaIndexOutOfBoundsException, (&_e)->what());
    return ;
  } catch(std::out_of_range &_e) {
...
SWIGEXPORT jlong JNICALL Java_com_seantone_sxtwl_sxtwlJNI_Day_1fromSolar_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jint jarg1, jshort jarg2, jint jarg3) {
  jlong jresult = 0 ;
  int arg1 ;
  uint8_t arg2 ;
  int arg3 ;
...
SWIGEXPORT jlong JNICALL Java_com_seantone_sxtwl_sxtwlJNI_Day_1fromSolar_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jint jarg1, jshort jarg2, jint jarg3, jint jarg4, jint jarg5, jint jarg6) {
  jlong jresult = 0 ;
  int arg1 ;
  uint8_t arg2 ;
  int arg3 ;
