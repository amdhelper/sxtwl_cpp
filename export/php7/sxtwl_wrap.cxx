...
static ZEND_NAMED_FUNCTION(_wrap_new_JDList__SWIG_1) {
  ...
  /*@SWIG:/home/didi88ss/venvs/venv3.12/lib/python3.12/site-packages/swig/data/share/swig/4.3.1/php/utils.i,6,CONVERT_INT_IN@*/
...
static PHP_METHOD(JDList,push) {
  ...
  /*@SWIG:/home/didi88ss/venvs/venv3.12/lib/python3.12/site-packages/swig/data/share/swig/4.3.1/php/utils.i,48,CONVERT_FLOAT_IN@*/
...
PHP_METHOD(Time,__set) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("Y_set", 0);
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("M_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("D_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("h_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("s_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
...
PHP_METHOD(Time,__get) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("Y_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("M_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("D_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("h_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("s_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
...
static PHP_METHOD(GZ,__construct) {
  ...
  if (argc == 2) {
    ...
    _v = (Z_TYPE(argv[0]) == IS_LONG &&
      (0 <= ZEND_LONG_MIN || (zend_long)0 <= Z_LVAL(argv[0])) &&
      (UCHAR_MAX >= ZEND_LONG_MAX || (zend_long)UCHAR_MAX >= Z_LVAL(argv[0])));
    
    if (_v) {
      _v = (Z_TYPE(argv[1]) == IS_LONG &&
        (0 <= ZEND_LONG_MIN || (zend_long)0 <= Z_LVAL(argv[1])) &&
        (UCHAR_MAX >= ZEND_LONG_MAX || (zend_long)UCHAR_MAX >= Z_LVAL(argv[1])));
...
PHP_METHOD(GZ,__set) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("tg_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("dz_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
...
PHP_METHOD(GZ,__get) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("tg_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("dz_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
...
static ZEND_NAMED_FUNCTION(_wrap_Day_fromSolar__SWIG_0) {
  int arg1 ;
  uint8_t arg2 ;
  int arg3 ;
  zval args[3];
...
static ZEND_NAMED_FUNCTION(_wrap_Day_fromSolar__SWIG_1) {
  int arg1 ;
  uint8_t arg2 ;
  int arg3 ;
  int arg4 ;
...
static PHP_METHOD(Day,fromSolar) {
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          _wrap_Day_fromSolar__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
        }
      }
    }
  }
          ...
          if (_v) {
            ...
            if (_v) {
              _v = (Z_TYPE(argv[5]) == IS_LONG &&
                (INT_MIN <= ZEND_LONG_MIN || (zend_long)INT_MIN <= Z_LVAL(argv[5])) &&
                (INT_MAX >= ZEND_LONG_MAX || (zend_long)INT_MAX >= Z_LVAL(argv[5])));
              
              if (_v) {
                _wrap_Day_fromSolar__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
              }
            }
          }
        }
  ...
  zend_throw_exception(zend_ce_type_error, "No matching function for overloaded 'Day_fromSolar'", 0);
fail:
  return;
}
...
static ZEND_NAMED_FUNCTION(_wrap_Day_fromLunar__SWIG_0) {
  ...
  /*@SWIG:/home/didi88ss/venvs/venv3.12/lib/python3.12/site-packages/swig/data/share/swig/4.3.1/php/utils.i,2,CONVERT_BOOL_IN@*/
...
PHP_METHOD(JieQiInfo,__set) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("jd_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("jqIndex_set", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 1, &args[1]);
  }
...
PHP_METHOD(JieQiInfo,__get) {
  ...
  if (!arg2) {
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("jd_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
    ...
    zend_string *swig_funcname = ZSTR_INIT_LITERAL("jqIndex_get", 0);
    zend_function *swig_zend_func = zend_std_get_method(&Z_OBJ_P(ZEND_THIS), swig_funcname, NULL);
    zend_string_release(swig_funcname);
    zend_call_known_instance_method(swig_zend_func, Z_OBJ_P(ZEND_THIS), return_value, 0, NULL);
  }
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(swig_arginfo_Day_fromSolar, 0, 6, Day, MAY_BE_NULL)
 ZEND_ARG_TYPE_MASK(0,arg1,MAY_BE_LONG,NULL)
 ZEND_ARG_TYPE_MASK(0,arg2,MAY_BE_LONG,NULL)
 ZEND_ARG_TYPE_MASK(0,arg3,MAY_BE_LONG,NULL)
