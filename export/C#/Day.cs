...
public class Day : global::System.IDisposable {
  ...
  public static Day fromSolar(int _year, byte _month, int _day) {
    global::System.IntPtr cPtr = sxtwlPINVOKE.Day_fromSolar__SWIG_0(_year, _month, _day);
    Day ret = (cPtr == global::System.IntPtr.Zero) ? null : new Day(cPtr, false);
    return ret;
  }

  public static Day fromSolar(int _year, byte _month, int _day, int _hour, int _minute, int _second) {
    global::System.IntPtr cPtr = sxtwlPINVOKE.Day_fromSolar__SWIG_1(_year, _month, _day, _hour, _minute, _second);
    Day ret = (cPtr == global::System.IntPtr.Zero) ? null : new Day(cPtr, false);
    return ret;
  }
